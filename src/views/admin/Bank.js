...
const Bank = () => {
  const { banklist, setBanklist, isEmpty } = useContext(contextApi);
  ...
  useEffect(() => {
    getBankList(search, sortColumn, orderType, page + 1, rowsPerPage);
  }, []);
  ...
  const emptyRows = banklist.rows.length < 1;
  ...
  // const GenerateArrowIcon = (prop) => {
  //   if (prop.sort == "id") {
  //     return (
  //       <Box component="span">
  //         {orderType == "asc" ? <ArrowDropUpIcon /> : <ArrowDropDownIcon />}
  //       </Box>
  //     );
  //   }
  // };
        ...
        <Card className={classes.root}>
          <CardContent>
            <Box className="table-top">
              ...
              <Box>
                <Link to="/admin/bank/0" className="btn primary">
                  <ControlPointIcon />
          ...
          <CardContent>
            <TableContainer component={Paper} className={classes2.container}>
              <Table stickyHeader aria-label="sticky table">
                ...
                <TableBody>
                  <GenerateTableRow list={banklist} load={loading} />
                  {emptyRows > 0 && (
                    <TableRow style={{ height: 53 * emptyRows }}>
            ...
            <TablePagination
              ...
              component="div"
              count={banklist.total}
              rowsPerPage={rowsPerPage}
              page={page}
              onChangePage={handleChangePage}
              onChangeRowsPerPage={handleChangeRowsPerPage}
            />
            {/* <Box className={classes2.pagination}>
